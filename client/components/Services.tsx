...
const Services = ({ data }: any) => {
  ...
  return (
    <section className="py-8 px-4  sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-800 text-white">
...
const ServiceCard = ({ data, index }: any) => {
  ...
  return (
    <motion.div
      className="flex flex-col rounded-lg overflow-hidden shadow-lg bg-gray-800 hover:shadow-2xl transition-shadow duration-300"
      initial={{ opacity: 0, y: 50 }}
      animate={{ opacity: 1, y: 0 }}
